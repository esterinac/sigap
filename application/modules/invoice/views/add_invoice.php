...
<div class="page-section">
    <div class="row">
        <div class="col-md-12">
            <section class="card">
                <div class="card-body">
                    <form action="<?= base_url("invoice/add_invoice"); ?>" method="post">
                        <fielsdet>
                            <legend>Form Tambah Faktur</legend>
                            <div class="form-group">
                                <label for="number" class="font-weight-bold">Nomor Faktur<abbr title="Required">*</abbr></label>
                                <input type="text" name="number" id="number" class="form-control"/>
                            </div>
                            <div class="form-group">
                                <label for="customer_name" class="font-weight-bold">Nama Customer<abbr title="Required">*</abbr></label>
                                <input type="text" name="customer_name" id="customer_name" class="form-control"/>
                            </div>
                            <div class="form-group">
                                <label for="customer_number" class="font-weight-bold">No HP Customer<abbr title="Required">*</abbr></label>
                                <input type="text" name="customer_number" id="customer_number" class="form-control"/>
                            </div>
                            <div class="form-group">
                                <label for="due_date" class="font-weight-bold">Jatuh Tempo<abbr title="Required">*</abbr></label>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-2">
                                <label for="amount" class="font-weight-bold">Jumlah</label>
                                <input type="number" min="1" name="amount" id="amount" class="form-control"/>
                            </div>
                            <div class="form-group col-md-2">
                                <label for="add_item" class="font-weight-bold">Tambah Barang</label>
                                <button type="button" id="add_item" name="add_item" class="form-control btn btn-primary text-white">Tambah Barang</button>
                            </div>
                        </div>
                        <hr>
                        <table class="table table-striped table-responsive">
                            <thead>
                                <tr class="text-center">
                                    ...
                                    <th scope="col" style="min-width:150px;">Jumlah</th>
